...
(let ((main-bg     "#1e1e1e")           ; Background colours
  ...
  (custom-theme-set-faces 'monokate
                          ...
                          `(vertico-current ((t (:background ,grey-1 :foreground ,white-fg :weight bold))))
                          `(ivy-current-match ((t (:background ,grey-1 :foreground ,white-fg :weight bold))))
                          `(completions-common-part ((t (:foreground ,white-fg :weight bold))))
                          `(completions-first-difference ((t (:foreground ,pastel-blue :weight bold))))
                          ...
                          ;; Doom compatibility
                          `(solaire-default-face ((t (:background ,main-bg))))
                          `(solaire-hl-line-face ((t (:background ,grey-1))))
                          `(vterm-color-default ((t (:background ,main-bg :foreground ,main-fg))))
                          `(corfu-default ((t (:background ,grey-1))))
                          `(corfu-current ((t (:background ,grey-2 :foreground ,white-fg :weight bold))))
                          `(company-tooltip ((t (:background ,grey-1))))
                          `(company-tooltip-selection ((t (:background ,grey-2 :foreground ,white-fg :weight bold))))
                          `(tooltip ((t (:background ,grey-1))))
                          `(markdown-code-face ((t (:background ,grey-1))))
                          `(markdown-inline-code-face ((t (:background ,grey-1))))
                          `(markdown-pre-face ((t (:background ,grey-1))))
                          `(eldoc-box-body ((t (:background ,main-bg))))
                          `(eldoc-box-border ((t (:background ,grey-1))))
                          )
